        ...
        1: [function (require, module, exports) {
            ...
            function createPanZoom(domElement, options) {
                ...
                function moveTo(x, y) {
                    ...
                    const adjusted = keepTransformInsideBounds();

                    if (adjusted[1] === true || adjusted[2] === true) {
                        stopPanning = [adjusted[1], adjusted[2]];
                    } else {
                        stopPanning = [adjusted[1], adjusted[2]];
                    }
                ...
                function keepTransformInsideBounds() {
                    ...
                    var adjusted = false;
                    var adjustedLeft = false;
                    var adjustedRight = false;
                    ...
                    return [adjusted, adjustedLeft, adjustedRight];
                }
                ...
                function zoomByRatio(clientX, clientY, ratio, shouldBound = false) {
                ...
                function handleTouchEnd(e) {
                    ...
                    if (e.touches.length > 0) {
                        ...
                        if (now - lastTouchEndTime < doubleTapSpeedInMS) {
                            ...
                            if (transformOrigin) {
                                if (lastTouchCoords == null || (Math.abs(offset.x - lastTouchCoords.x) < 20 && Math.abs(offset.y - lastTouchCoords.y) < 20)) {

                                    var offset = getTransformOriginOffset();
                                    if (transform.scale > 1.1) {
                                        keepTransformInsideBounds();
                                        zoomByRatio(offset.x, offset.y, 0, true);
                                    } else {
                                ...
                                if (lastTouchCoords == null || (Math.abs(lastSingleFingerOffset.x - lastTouchCoords.x) < 20 && Math.abs(lastSingleFingerOffset.y - lastTouchCoords.y) < 20)) {
                                    {
                                        // We want untransformed x/y here.
                                        if (transform.scale > 1.1) {
                                            keepTransformInsideBounds();
                                            zoomByRatio(lastSingleFingerOffset.x, lastSingleFingerOffset.y, 0, true);
                                        } else {
                        ...
                        if (transformOrigin) {
                            ...
                            lastTouchCoords = {
                                x: lastSingleFingerOffset.x,
                                y: lastSingleFingerOffset.y
                            };
                        }
                        triggerPanEnd();
                        releaseTouches();
