...
function ini(urlToLoad){ // webpackBootstrap
/******/ 	"use strict";
...
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
    ...
    Object.defineProperty(exports, "__esModule", ({
      ...
      const defaultOptions = {
        ...
        workerSrc: {
          value: "../../assets/libs/pdf.worker.js",
          kind: OptionKind.WORKER
        }
      };
      {
      ...
      class PDFDocumentProperties {
        ...
        constructor({
          ...
          eventBus._on("pagechanging", evt => {
            ...
            try{
              totalPages = temp1.source._pages.length;
            }catch(err){
              console.warn(err);
            }
...
window.onmessage = function(event){
  location.replace(`#page=${event.data.pageNum}`);
  ini(event.data.url);
};

// https://momot.in/d1/x/1687654667/20000/e/lgrsnf/975000/510e6c5f3a02de4187451b5c498e9a55~/zxlHH6JOjSW3zIFY7Akg7A/oligopoly-dynamics-models-and-tools-t%C3%B6nu-puu-auth--annas-archive.pdf