...
chrome2:
	...
	echo 'var config = {"local": localStorage.getItem("local") === "true", "remote": localStorage.getItem("remote"),"remoteWOport": localStorage.getItem("remoteWOport"), "chrome": true, "manifest": "v2", "firefox": false, "beta": false, "sockets": false}; localStorage.setItem("version", "1.3.3");if (localStorage.getItem("lastUpdate") === null) { localStorage.setItem("lastUpdate", "0");}' > enimax-chrome-extension-v2/www/assets/js/config.js
...
chrome3:
	...
	echo 'var config = {"local": localStorage.getItem("local") === "true", "remote": localStorage.getItem("remote"),"remoteWOport": localStorage.getItem("remoteWOport"), "chrome": true, "manifest": "v3", "firefox": false, "beta": false, "sockets": false}; localStorage.setItem("version", "1.3.3");if (localStorage.getItem("lastUpdate") === null) {localStorage.setItem("lastUpdate", "0");}' > enimax-chrome-extension/www/assets/js/config.js
...
firefox:
	...
	echo 'var config = {"local": localStorage.getItem("local") === "true", "remote": localStorage.getItem("remote"),"remoteWOport": localStorage.getItem("remoteWOport"), "chrome": true, "manifest": "v2", "firefox": true, "beta": false, "sockets": false}; localStorage.setItem("version", "1.3.3");if (localStorage.getItem("lastUpdate") === null) {localStorage.setItem("lastUpdate", "0");}' > enimax-firefox-extension/www/assets/js/config.js
